package br.com.attomtech.talbosch.api.exception.handler;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler
{
    ...
    public ResponseEntity<Object> handleNegocioException( NegocioException e, WebRequest request )
    {
        ...
        String mensagemDesenvolvedor = ExceptionUtils.getRootCauseMessage( e );
    ...
    private List<Erro> criarListaDeErros( BindingResult bindingResult )
    {
        ...
        {
            msgUsuario       = messageSource.getMessage( fieldError, LocaleContextHolder.getLocale( ) );
